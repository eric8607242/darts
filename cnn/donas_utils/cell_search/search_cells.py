...
from .cell_operations import OPS, NAS_BENCH_201
...
class NAS201SearchCell(nn.Module):
  ...
  def set_training_order(self, training_orders, training_orders_index):
      self.training_orders = training_orders
      self.training_orders_index = training_orders_index
    ...
    for i in range(1, self.max_nodes):
      while True: # to avoid select zero for all ops
        ...
        for j in range(i):
          ...
          #select_op = self.training_orders[node_str][self.training_orders_index[node_str]]
